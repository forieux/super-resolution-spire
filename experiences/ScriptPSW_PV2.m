...
for hyp_ind = 1:size(hyp_tab,2)
    ...
    [mapCg2 offsetsCg ooptimCg] = inversionOffsets2(init, cgoptions, data250, [hyp_tab(hyp_ind); 1e1], Hdirect250, index250, coefs250, offsets, diffOp, objectMean, Nalpha, Nbeta, Norder, N_scan_total, Nbolo250, Nspeed, unique_speed, the_speeds, 5);

end
T2 = toc;

T/T2
disp('Greater than 1 is better')
