%% biaisCirrusDCT - Compute the biais of the estimator

placemount = '/espace/orieux/results/'
expname = 'biaisCirrusDCT';
...
for itask = 1:Ntasks
    %% Generate new data (the noise realisation is different)
    [data output data250 data360 data520 sky] = simulateData(['../data&true/' ...
                        'simul_ism_SPS_comp'], Nalpha, Nbeta, Norder, [1 ...
                        1 1], std, 10^(-4), Hrond250, Hrond360, Hrond520, ...
                                                      index250, index360, ...
                                                      index520);
    %% Init
