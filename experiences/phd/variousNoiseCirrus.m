...
for itask = 1:length(alltasks)
    ...
    name = [placemount,expname,'/gpac_',num2str(variousNoise(1)),'_',num2str(itask),'.mat'];
...
for itask = 1:length(alltasks)
    ...
    name = [placemount,expname,'/gpac_',num2str(variousNoise(2)),'_',num2str(itask)];
    save(name, 'xchap', 'hypers', 'SortieOPS', 'Histo')
