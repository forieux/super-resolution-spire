...
figplace = '/home/orieux/tex/manuscrit/imagesRes/cirrusDot/';
...
% for itask = 1:Ntasks
%     for iworker = 1:8
%         name = [placemount,'varianceCirrusDotDCT','/sample_',num2str(itask),'_',num2str(iworker)];
%         load(name, 'skySample')
