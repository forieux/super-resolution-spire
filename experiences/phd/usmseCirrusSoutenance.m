...
%% GPAC Options
OPS(1)	 = 10;		% Affichage toutes les OPS(1) itérations
...
criterion = 1e-5;
burnin = 500; %% If you absolutly don't knwo this value it is more than 100
